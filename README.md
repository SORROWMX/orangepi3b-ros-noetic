...
Этот репозиторий содержит предварительно скомпилированные пакеты ROS Noetic для архитектуры ARM64, специально разработанные для одноплатных компьютеров Orange Pi 3B под управлением Ubuntu 20.04 (Focal Fossa) и Debian Bookworm (12).

## 📦 Статистика пакетов

- **Всего .deb файлов**: 150
- **Архитектура**: ARM64 (aarch64)
- **Целевая ОС**: Ubuntu 20.04 Focal Fossa / Debian Bookworm (12)
- **Дистрибуция ROS**: Noetic Ninjemys
- **Совместимость**: ✅ Кросс-совместимость между Ubuntu Focal и Debian Bookworm
...
- **Архитектура**: ARM64 (aarch64)
- **ОС**: Ubuntu 20.04 LTS Focal Fossa / Debian Bookworm (12)

## 🔄 Совместимость ОС

### ✅ Поддерживаемые операционные системы
- **Ubuntu 20.04 LTS Focal Fossa** (основная цель)
- **Debian Bookworm (12)** (полная совместимость)
- **Другие Debian-based дистрибутивы** с похожими версиями библиотек

### 📝 Именование пакетов
- Пакеты имеют суффикс `-0focal` (именование Ubuntu Focal)
- **Полностью совместимы** с Debian Bookworm несмотря на название
- Используйте `rename_packages.sh` для переименования для Debian Bookworm при необходимости

### 🔧 Переименование для Debian Bookworm
```bash
# Сделать скрипт исполняемым
chmod +x rename_packages.sh

# Переименовать пакеты с -0focal на -0bookworm
./rename_packages.sh
```
...
- Совместимы с Ubuntu 20.04 Focal Fossa и Debian Bookworm (12)
- Включают как релизные, так и отладочные пакеты
- Некоторые пакеты могут требовать дополнительные системные зависимости
- Именование пакетов использует конвенцию Ubuntu Focal, но работает на Debian Bookworm
...
**Совместимость**: Ubuntu Focal / Debian Bookworm  
